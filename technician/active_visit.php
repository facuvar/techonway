...
// Page title
$pageTitle = __('visits.view.info_title', 'Visita Activa');
...
<div class="container-fluid py-4">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-clock-history"></i> <?php echo __('visits.status.in_progress', 'En Progreso'); ?> - <?php echo __('common.ticket', 'Ticket'); ?> #<?php echo $visit['ticket_id']; ?>
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h6><?php echo __('common.client', 'Cliente'); ?>:</h6>
                            <p>
                        ...
                        <div class="col-md-6">
                            <h6><?php echo __('visits.view.info_title', 'Información de la Visita'); ?>:</h6>
                            <p>
                                <strong><?php echo __('common.start', 'Inicio'); ?>:</strong> <?php echo date('d/m/Y H:i', strtotime($visit['start_time'])); ?><br>
                                <strong><?php echo __('common.duration', 'Duración'); ?>:</strong> 
            ...
            <div class="card mt-4">
                <div class="card-header">
                    <h5 class="card-title"><?php echo __('visits.actions.finish', 'Finalizar'); ?> <?php echo __('visits.title.view', 'Detalles de Visita'); ?></h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button id="finalizarDirectamente" class="btn btn-success">
                            <i class="bi bi-check-circle"></i> <?php echo __('visits.actions.finish_direct', 'Finalizar Directamente'); ?> (<?php echo __('common.map', 'Mapa'); ?> / GPS)
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card mt-4">
                <div class="card-header">
                    <h5 class="card-title"><?php echo __('visits.view.timer.elapsed', 'Tiempo transcurrido:'); ?></h5>
                </div>
                <div class="card-body text-center">
                    <div id="timer" class="display-4 mb-3">00:00:00</div>
                    <p class="text-muted"><?php echo __('visits.view.timer.not_started', 'Visita no iniciada'); ?></p>
                </div>
            </div>
        </div>
    </div>
