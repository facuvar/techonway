...
// Título de la página
$pageTitle = __('import_clients.title', 'Importar Clientes');
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><?php echo __('import_clients.header', 'Importar Clientes desde Excel'); ?></h1>
</div>
...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5><?php echo __('import_clients.instructions.title', 'Instrucciones'); ?></h5>
            </div>
            <div class="card-body">
                <p><?php echo __('import_clients.instructions.p', 'Para importar clientes desde un archivo Excel, siga estos pasos:'); ?></p>
                <ol>
                    <li><?php echo __('import_clients.instructions.p', 'Para importar clientes desde un archivo Excel, siga estos pasos:'); ?>
                        <ul>
                            <?php foreach (__('import_clients.instructions.headers', []) as $hdr): ?>
                                <li><?php echo $hdr; ?></li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
                    <li><?php echo __('import_clients.instructions.note1', 'Asegúrese de que la primera fila contenga estos encabezados exactamente como se muestran.'); ?></li>
                    <li><?php echo __('import_clients.instructions.note2', 'Complete los datos de los clientes en las filas siguientes.'); ?></li>
                    <li><?php echo __('import_clients.instructions.note3', 'Guarde el archivo y súbalo utilizando el formulario de abajo.'); ?></li>
                </ol>
                <a href="<?php echo BASE_URL; ?>/admin/generate_template.php" class="btn btn-success">
                    <i class="bi bi-file-earmark-excel"></i> <?php echo __('import_clients.download_template', 'Descargar Plantilla'); ?>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5><?php echo __('import_clients.upload.title', 'Cargar Archivo'); ?></h5>
            </div>
            <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="excel_file" class="form-label"><?php echo __('import_clients.upload.label', 'Archivo Excel'); ?></label>
                        <input type="file" class="form-control" id="excel_file" name="excel_file" accept=".xls,.xlsx" required>
                        <div class="form-text"><?php echo __('import_clients.upload.help', 'Seleccione un archivo Excel (.xls o .xlsx)'); ?></div>
                    </div>
                    <button type="submit" class="btn btn-primary"><?php echo __('import_clients.upload.button', 'Importar Clientes'); ?></button>
                </form>
            </div>
        </div>
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h5><?php echo __('import_clients.sample.title', 'Plantilla de Ejemplo'); ?></h5>
            </div>
            <div class="card-body">
                <p><?php echo __('import_clients.sample.desc', 'Descargue una plantilla de ejemplo para importar clientes:'); ?></p>
                <a href="../templates/generate_client_template.php" class="btn btn-secondary">
                    <i class="bi bi-download"></i> <?php echo __('import_clients.download_template', 'Descargar Plantilla'); ?>
                </a>
            </div>
        </div>
    </div>
