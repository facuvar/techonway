...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/admin/clients_railway.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/tickets_railway.php">
                    <i class="bi bi-ticket-perforated"></i> Tickets
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/calendar_dashboard.php?token=dashboard_access">
