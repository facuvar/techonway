...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['save_technician'])) {
        ...
        if (empty($technicianData['name']) || empty($technicianData['email']) || empty($technicianData['zone'])) {
            flash(__('technicians.flash.required_fields', 'Por favor, complete todos los campos obligatorios.'), 'danger');
        } else {
            ...
            if ($existingUser) {
                ...
                if (isset($_POST['technician_id']) && !empty($_POST['technician_id'])) {
                    ...
                    flash(__('technicians.flash.created', 'Técnico creado correctamente.'), 'success');
                    ...
                    if (!empty($technicianData['phone'])) {
                        ...
                        if ($result) {
                            flash(__('technicians.flash.welcome_sent', 'Se ha enviado un mensaje de bienvenida al técnico. Debe responder al mensaje para activar las notificaciones.'), 'info');
                        } else {
                            flash(__('technicians.flash.welcome_failed', 'No se pudo enviar el mensaje de bienvenida. El técnico debe enviar un mensaje al número de WhatsApp Business para activar las notificaciones.'), 'warning');
                        }
                    } else {
                        flash(__('technicians.flash.no_phone', 'El técnico no tiene número de teléfono registrado. No recibirá notificaciones por WhatsApp.'), 'warning');
                    }
                }
    ...
    if (isset($_POST['delete_technician'])) {
        ...
        if ($technicianId) {
            ...
            if ($ticketsCount > 0) {
                flash(__('technicians.flash.delete_blocked_has_tickets', 'No se puede eliminar el técnico porque tiene tickets asociados.'), 'danger');
            } else {
                $db->delete('users', 'id = ?', [$technicianId]);
                flash(__('technicians.flash.deleted', 'Técnico eliminado correctamente.'), 'success');
            }
        }
    ...
    if (isset($_POST['resend_whatsapp'])) {
        ...
        if ($technicianId) {
            ...
            if ($technician && !empty($technician['phone'])) {
                ...
                if ($result) {
                    flash(__('technicians.flash.resend_success', 'Se ha reenviado el mensaje de bienvenida al técnico. Debe responder al mensaje para activar las notificaciones.'), 'success');
                } else {
                    flash(__('technicians.flash.resend_failed', 'No se pudo reenviar el mensaje de bienvenida. Verifique que el número de teléfono sea correcto. Revise los logs para más detalles.'), 'danger');
                }
            } else {
                flash(__('technicians.flash.no_phone', 'El técnico no tiene número de teléfono registrado. No se puede enviar el mensaje.'), 'warning');
            }
...
if (($action === 'edit' || $action === 'view') && $technicianId) {
    ...
    if (!$technician) {
        flash(__('technicians.flash.not_found', 'Técnico no encontrado.'), 'danger');
        redirect('admin/technicians.php');
    }
}
...
$pageTitle = match($action) {
    'create' => __('technicians.title.create', 'Crear Técnico'),
    'edit' => __('technicians.title.edit', 'Editar Técnico'),
    'view' => __('technicians.title.view', 'Ver Técnico'),
    default => __('technicians.title.index', 'Gestión de Técnicos')
};
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <?php if ($action === 'list'): ?>
            <a href="?action=create" class="btn btn-primary">
                <i class="bi bi-plus-circle"></i> <?php echo __('technicians.actions.new', 'Nuevo Técnico'); ?>
            </a>
        <?php else: ?>
    ...
    <?php if ($action === 'list'): ?>
        ...
        <div class="card">
            <div class="card-body">
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo __('common.zone', 'Zona'); ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="?action=view&id=<?php echo $tech['id']; ?>" class="btn btn-info">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="?action=edit&id=<?php echo $tech['id']; ?>" class="btn btn-primary">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <?php echo __('technicians.delete.confirm_message', '¿Está seguro de que desea eliminar este técnico?'); ?> <strong><?php echo escape($tech['name']); ?></strong>
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <form method="post" action="<?php echo BASE_URL; ?>admin/technicians.php">
                                                                ...
                                                                <button type="submit" name="delete_technician" class="btn btn-danger"><?php echo __('common.delete', 'Eliminar'); ?></button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <?php else: ?>
                    <p class="text-center"><?php echo __('technicians.list.empty', 'No hay técnicos registrados'); ?></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="<?php echo BASE_URL; ?>admin/technicians.php">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="name" class="form-label"><?php echo __('technicians.form.name', 'Nombre'); ?> *</label>
                            <input type="text" class="form-control" id="name" name="name" 
                                   value="<?php echo $action === 'edit' ? escape($technician['name']) : ''; ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label"><?php echo __('technicians.form.email', 'Email'); ?> *</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="phone" class="form-label"><?php echo __('technicians.form.phone', 'Teléfono'); ?></label>
                        ...
                        <div class="col-md-6">
                            <label for="zone" class="form-label"><?php echo __('technicians.form.zone', 'Zona'); ?> *</label>
                            <select class="form-select" id="zone" name="zone" required>
                                <option value=""><?php echo __('technicians.form.select_zone', 'Seleccionar zona'); ?></option>
                    ...
                    <div class="mb-3">
                        <label for="password" class="form-label">
                            <?php echo $action === 'edit' ? __('technicians.form.password_hint_edit', 'Contraseña (dejar en blanco para mantener la actual)') : __('technicians.form.password_hint_create', 'Contraseña *'); ?>
                        </label>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title"><?php echo __('technicians.view.info_title', 'Información del Técnico'); ?></h5>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <tr>
                                <th><?php echo __('technicians.view.name', 'Nombre'); ?>:</th>
                                <td><?php echo escape($technician['name']); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo __('technicians.view.email', 'Email'); ?>:</th>
                                <td><?php echo escape($technician['email']); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo __('technicians.view.phone', 'Teléfono'); ?>:</th>
                                <td><?php echo escape($technician['phone']); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo __('technicians.view.zone', 'Zona'); ?>:</th>
                                <td><?php echo escape($technician['zone']); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo __('technicians.view.registered_at', 'Fecha de Registro'); ?>:</th>
                            ...
                            <?php if (!empty($technician['phone'])): ?>
                                <form method="post" action="<?php echo BASE_URL; ?>admin/technicians.php" class="ms-2 d-inline">
                                    ...
                                    <button type="submit" name="resend_whatsapp" class="btn btn-info">
                                        <i class="bi bi-whatsapp"></i> <?php echo __('technicians.view.resend_whatsapp', 'Reenviar Mensaje de WhatsApp'); ?>
                                    </button>
                                </form>
                            <?php endif; ?>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title"><?php echo __('technicians.view.tickets_title', 'Tickets Asignados'); ?></h5>
                        <a href="<?php echo BASE_URL; ?>admin/tickets.php?action=create&technician_id=<?php echo $technician['id']; ?>" class="btn btn-sm btn-primary">
                            <i class="bi bi-plus-circle"></i> <?php echo __('technicians.view.assign_ticket', 'Asignar Ticket'); ?>
                        </a>
                    </div>
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <p class="text-center"><?php echo __('technicians.view.no_tickets', 'No hay tickets asignados a este técnico'); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h5 class="card-title"><?php echo __('technicians.view.statistics', 'Estadísticas'); ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="card bg-dark-surface-2">
                                    <div class="card-body text-center">
                                        ...
                                        <p><?php echo __('technicians.stats.total_tickets', 'Total de Tickets'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="card bg-dark-success">
                                    <div class="card-body text-center">
                                        ...
                                        <p><?php echo __('technicians.stats.completion_rate', 'Tasa de Finalización'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card bg-dark-warning">
                                    <div class="card-body text-center">
                                        ...
                                        <p><?php echo __('technicians.stats.pending', 'Pendientes'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <div class="card bg-dark-info">
                                    <div class="card-body text-center">
                                        ...
                                        <p><?php echo __('technicians.stats.in_progress', 'En Progreso'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <div class="card bg-dark-success">
                                    <div class="card-body text-center">
                                        ...
                                        <p><?php echo __('technicians.stats.completed', 'Completados'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <div class="card bg-dark-danger">
                                    <div class="card-body text-center">
                                        ...
                                        <p><?php echo __('technicians.stats.not_completed', 'No Completados'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
