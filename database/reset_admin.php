...
try {
    ...
    try {
        ...
        $result = $pdo->query("SELECT SCHEMA_NAME FROM INFORMATION_SCHEMA.SCHEMATA WHERE SCHEMA_NAME = 'techonway'")->fetchColumn();
        
        if (!$result) {
            echo "<p>La base de datos 'techonway' no existe. Por favor, ejecute el script de configuración primero.</p>";
